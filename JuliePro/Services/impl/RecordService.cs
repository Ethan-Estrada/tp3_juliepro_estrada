...
namespace JuliePro.Services.impl
{
    public class RecordService : ServiceBaseEF<Record>, IRecordService
    {
        ...
        public async Task<IReadOnlyList<RecordViewModel>> GetAllAsync()
        {
        ...
        public async Task<IPaginatedList<RecordViewModel>> GetAllPaginatedAsync(int pageIndex, int pageSize)
        {
