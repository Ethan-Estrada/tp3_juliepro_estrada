...
namespace JuliePro.Models
{
    ...
    public class TrainersDisciplinesViewModel {
        ...
        public TrainersDisciplinesViewModel()
        {
        ...
        {
            trainers = trainers ?? new List<Trainer>();
            disciplines = disciplines ?? new List<Discipline>();

            this.Trainers = new SelectList(trainers.Select(x => new SelectListItem() { Text = x.FullName, Value = x.Id.ToString() }).ToList(),"Value","Text");
    ...
    public class RecordViewModel
    {
        ...
        public RecordViewModel(Record model, List<Trainer> trainers=null, List<Discipline> disciplines=null)
        {
            this.Id = model.Id;
        ...
        public void PasteViewModel(RecordViewModel model) {
            this.Id = model.Id;
            this.Date = model.Date;
            this.Amount = model.Amount;
            this.Unit = model.Unit;
            this.SelectedDisciplineId = model.SelectedDisciplineId;
            this.SelectedTrainerId = model.SelectedTrainerId;
