...
namespace JuliePro_DataAccess.DataSeed
{
    ...
    {
        public JulieProDbContextSeedDev(ILogger<JulieProDbContextSeed> logger, JulieProDbContext context, IHostingEnvironment environement) : base(logger, context, environement.WebRootPath)
        {
